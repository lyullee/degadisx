...
class JetPlume:
    ...
    def __init__(
        ...
        #: underside and holds the plume down.
        #:
        ...
        #:
        #: Reading buoyancy off the gas line alone can launch a jet far denser
        #: than air as though it were barely denser, so a horizontal release
        #: climbs where it should fall. A ground-interacting jet should retain
